...
// Mapping of PD ammo types to PCDX ammo types
s32 g_SetupPerfectDarkAmmoMappings[] = {
	AMMOTYPE_NONE,
	AMMOTYPE_PISTOL,
	AMMOTYPE_SMG,
	AMMOTYPE_CROSSBOW,
...
s32 g_SetupGoldenEyeX5eWeaponMappings[] = {
	WEAPON_NONE,
	WEAPON_UNARMED,
...
// Mapping of GEX 5e ammo types to PCDX ammo types
s32 g_SetupGoldenEyeX5eAmmoMappings[] = {
	AMMOTYPE_NONE, // Confirmed
	AMMOTYPE_PISTOL, // Confirmed
	AMMOTYPE_SMG, // Confirmed
	AMMOTYPE_CROSSBOW,
	AMMOTYPE_RIFLE, // Confirmed
	AMMOTYPE_SHOTGUN,
	AMMOTYPE_FARSIGHT,
	AMMOTYPE_GRENADE,
	AMMOTYPE_ROCKET,
	AMMOTYPE_KNIFE,
	AMMOTYPE_MAGNUM,
	AMMOTYPE_DEVASTATOR, // Confirmed (Grenade Rounds)
	AMMOTYPE_REMOTE_MINE,
	AMMOTYPE_PROXY_MINE,
	AMMOTYPE_TIMED_MINE,
	AMMOTYPE_WATCHLASER, // Confirmed
	AMMOTYPE_GOLDENBULLET, // Confirmed
	AMMOTYPE_DART,
	AMMOTYPE_NBOMB,
	AMMOTYPE_SEDATIVE,
	AMMOTYPE_CLOAK,
...
void setupLoadMappings(s32 fileNum)
{
	...
	for (int i = 0; i < ARRAYCOUNT(g_SetupAmmoMappings); i++)
	{
	...
	{
		g_SetupAmmoMappings[i] = g_SetupPerfectDarkAmmoMappings[i];
	}
}
