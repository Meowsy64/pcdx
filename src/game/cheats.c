...
struct cheat g_Cheats[] = {
	...
	{ L_MPWEAPONS_079,              TIME(7 m,  7 s),   SOLOSTAGEINDEX_PELAGIC,        DIFF_SA, CHEATFLAG_TIMED,                                                                               { CHEAT_UNLIMITEDAMMONORELOADS } }, // Unlimited Ammo
	{ L_MPWEAPONS_080,              TIME(3 m, 11 s),   SOLOSTAGEINDEX_AIRBASE,        DIFF_SA, CHEATFLAG_TIMED,                                                                               { CHEAT_UNLIMITEDAMMO          } }, // Unlimited Ammo, No Reloads
#else
